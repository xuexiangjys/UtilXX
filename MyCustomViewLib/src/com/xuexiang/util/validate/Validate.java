...
import com.xuexiang.util.validate.bean.Basebean;
import com.xuexiang.util.validate.bean.LengthBean;
import com.xuexiang.util.validate.bean.MoneyBean;
import com.xuexiang.util.validate.bean.NotNullBean;
		...
		public void run() {
			try {
				...
				for (Field field : clazz.getDeclaredFields()) {
					if (field.isAnnotationPresent(NotNull.class) || field.isAnnotationPresent(RE.class) || field.isAnnotationPresent(MaxLength.class) || field.isAnnotationPresent(MinLength.class)
							|| field.isAnnotationPresent(Index.class) || field.isAnnotationPresent(Money.class) || field.isAnnotationPresent(Password1.class)
