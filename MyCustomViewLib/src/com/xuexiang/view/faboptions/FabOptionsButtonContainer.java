...
public class FabOptionsButtonContainer extends LinearLayout {
    ...
    public ImageView addButton(Context context, int buttonId, CharSequence title, Drawable drawableIcon) {
        return addButton(context, buttonId, title, drawableIcon, null);
    }

    public ImageView addButton(Context context, int buttonId, CharSequence title, Drawable drawableIcon, Integer index) {
        ImageView fabOptionButton =
                (ImageView) LayoutInflater.from(context).inflate(R.layout.faboptions_button, this, false);
