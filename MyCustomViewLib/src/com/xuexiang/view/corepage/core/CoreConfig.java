...
/**
 * 全局配置类 User:lizhangqu(513163535@qq.com) Date:2015-07-22 Time: 12:24
 */
public class CoreConfig {
	 ...
	 *            配置的页面信息
	 */
	public static void init(Context context, List<PageItem> pageItemList) {
		CoreConfig.init(context, JSON.toJSONString(pageItemList));
	}
	 ...
	 *            配置的页面信息
	 */
	public static void init(Context context, PageItem pageItem) {
