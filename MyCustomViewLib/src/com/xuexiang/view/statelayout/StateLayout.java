package com.xuexiang.view.statelayout;
...
public class StateLayout extends FrameLayout {
	...
	private void parseAttrs(Context context, AttributeSet attrs) {
		...
		try {
			errorDrawable = a.getDrawable(R.styleable.StateLayout_sl_errorDrawable);
			emptyDrawable = a.getDrawable(R.styleable.StateLayout_sl_emptyDrawable);
			progressViewId = a.getResourceId(R.styleable.StateLayout_sl_progressView, -1);
		} finally {
			a.recycle();
		}
		...
		if (progressViewId != -1) {
			...
			progressView = inflater.inflate(R.layout.statelayout_view_progress, this, false);
		...
		errorView = inflater.inflate(R.layout.statelayout_view_error, this, false);
		...
		emptyView = inflater.inflate(R.layout.statelayout_view_empty, this, false);
		...
		if (emptyDrawable != null) {
			...
			emptyImageView.setImageResource(R.drawable.ic_state_layout_empty);
		}
		addView(emptyView);
		/******************************************************************************************/
