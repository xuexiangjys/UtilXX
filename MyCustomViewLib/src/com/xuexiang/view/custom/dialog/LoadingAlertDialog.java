package com.xuexiang.view.custom.dialog;
...
public class LoadingAlertDialog extends Dialog {
        ...
        mModalOutAnim.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                ...
                mDialogView.post(new Runnable() {
                    ...
                    public void run() {
                        if (mCloseFromCancel) {
                            LoadingAlertDialog.super.cancel();
                        } else {
                            LoadingAlertDialog.super.dismiss();
                        }
                    }
                });
            }
    ...
    public LoadingAlertDialog setTitleText(String text) {
        mTitleText = text;
