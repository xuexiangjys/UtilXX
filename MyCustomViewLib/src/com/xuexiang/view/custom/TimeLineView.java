...
public class TimeLineView extends View {
	...
	private void initAttrs(AttributeSet paramAttributeSet) {
		if (paramAttributeSet != null) {
			...
			mStartedLineColor = typedArray.getColor(R.styleable.TimeLineView_TLV_startedLineColor, Color.BLUE);
			mPreLineColor = typedArray.getColor(R.styleable.TimeLineView_TLV_preLineColor, Color.GRAY);

			mStartedCircleColor = typedArray.getColor(R.styleable.TimeLineView_TLV_startedCircleColor, Color.BLUE);
			mUnderwayCircleColor = typedArray.getColor(R.styleable.TimeLineView_TLV_underwayCircleColor, Color.BLUE);
			mPreCircleColor = typedArray.getColor(R.styleable.TimeLineView_TLV_preCircleColor, Color.GRAY);

			mStartedStringColor = typedArray.getColor(R.styleable.TimeLineView_TLV_startedStringColor, Color.BLUE);
			mUnderwayStringColor = typedArray.getColor(R.styleable.TimeLineView_TLV_underwayStringColor, Color.BLUE);
			mPreStringColor = typedArray.getColor(R.styleable.TimeLineView_TLV_preStringColor, Color.GRAY);
			mTextSize = typedArray.getDimension(R.styleable.TimeLineView_TLV_textSize, 20);
			mRadius = (int) typedArray.getDimension(R.styleable.TimeLineView_TLV_radius, 10);
			mLineWidth = typedArray.getDimension(R.styleable.TimeLineView_TLV_lineWidth, 5);
			typedArray.recycle();
		}
	}
	...
	public void setPointStrings(@NonNull String[] pointStringList, @IntRange(from = 1) int step) {
		if (pointStringList == null) {
			...
			setPointStrings(new ArrayList<String>(Arrays.asList(pointStringList)), step);
		}
	}
	...
	public class Builder {
		...
		public Builder pointStrings(@NonNull String[] pointStringList, @IntRange(from = 1) int step) {
			if (pointStringList == null) {
				...
				return pointStrings(new ArrayList<String>(Arrays.asList(pointStringList)), step);
			}
		}
