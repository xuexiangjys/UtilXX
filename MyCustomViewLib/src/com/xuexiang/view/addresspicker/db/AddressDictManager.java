package com.xuexiang.view.addresspicker.db;
...
import com.xuexiang.view.addresspicker.bean.AdressBean;
...
public class AddressDictManager {
    ...
    public List<AdressBean.ChangeRecordsBean> getAddressList(){
        ...
        while (cursor.moveToNext()){
            ...
            adressInfo.parentId = cursor.getInt(cursor.getColumnIndex(TableField.ADDRESS_DICT_FIELD_PARENTID));
    ...
    public List<Province> getProvinceList(){
        ...
        Cursor cursor = db.rawQuery("select * from " + TableField.TABLE_ADDRESS_DICT+" where "+ TableField.ADDRESS_DICT_FIELD_PARENTID+"=?", new String[]{String.valueOf(0)});
        while (cursor.moveToNext()){
            Province province =  new Province();
            province.id = cursor.getInt(cursor.getColumnIndex(TableField.ADDRESS_DICT_FIELD_ID));
    ...
    public List<City> getCityList(int  provinceId){
        ...
        Cursor cursor = db.rawQuery("select * from " + TableField.TABLE_ADDRESS_DICT+" where "+ TableField.ADDRESS_DICT_FIELD_PARENTID+"=?", new String[]{String.valueOf(provinceId)});
        while (cursor.moveToNext()){
            City city =  new City();
            city.id = cursor.getInt(cursor.getColumnIndex(TableField.ADDRESS_DICT_FIELD_ID));
    ...
    public List<County> getCountyList(int cityId){
        ...
        Cursor cursor = db.rawQuery("select * from " + TableField.TABLE_ADDRESS_DICT+" where "+ TableField.ADDRESS_DICT_FIELD_PARENTID+"=?", new String[]{String.valueOf(cityId)});
        while (cursor.moveToNext()){
            County county = new County();
            county.id = cursor.getInt(cursor.getColumnIndex(TableField.ADDRESS_DICT_FIELD_ID));
    ...
    public List<Street> getStreetList(int countyId){
        ...
        Cursor cursor = db.rawQuery("select * from " + TableField.TABLE_ADDRESS_DICT+" where "+ TableField.ADDRESS_DICT_FIELD_PARENTID+"=?", new String[]{String.valueOf(countyId)});
        while (cursor.moveToNext()){
            Street street = new Street();
            street.id = cursor.getInt(cursor.getColumnIndex(TableField.ADDRESS_DICT_FIELD_ID));
