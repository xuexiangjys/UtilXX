...
public class ViewTooltip {
	...
	private static class ViewTooltip_view extends FrameLayout {
		...
		protected void onSizeChanged(int width, int height, int oldw, int oldh) {
			 ...
			 * float x = 0; float y = 0;
			 * 
			 * switch (position) { case TOP: { bubblePath.moveTo(x, y);
			 * bubblePath.lineTo((x = width), y); bubblePath.lineTo(x, (y =
			 * height - ARROW_HEIGHT)); bubblePath.lineTo((x = width / 2f +
			 * ARROW_WIDTH), y); bubblePath.lineTo((x = width / 2f), (y =
			 * height)); bubblePath.lineTo((x = width / 2f - ARROW_WIDTH), (y =
			 * height - ARROW_HEIGHT)); bubblePath.lineTo((x = 0), y);
			 * bubblePath.lineTo((x = 0), y); bubblePath.close(); } break; case
			 * BOTTOM: { bubblePath.moveTo(x, (y = ARROW_HEIGHT));
			 * bubblePath.lineTo((x = width / 2f - ARROW_WIDTH), y);
			 * bubblePath.lineTo((x = width / 2f), (y = 0));
			 * bubblePath.lineTo((x = width / 2f + ARROW_WIDTH), (y =
			 * ARROW_HEIGHT)); bubblePath.lineTo((x = width), y);
			 * bubblePath.lineTo(x, (y = height)); bubblePath.lineTo((x = 0),
			 * y); bubblePath.close(); } break; case LEFT: {
			 * bubblePath.moveTo(x, y); bubblePath.lineTo((x = width -
			 * ARROW_HEIGHT), y); bubblePath.lineTo(x, (y = height / 2 -
			 * ARROW_WIDTH)); bubblePath.lineTo((x = width - ARROW_HEIGHT), (y =
			 * height / 2 - ARROW_WIDTH)); bubblePath.lineTo((x = width), (y =
			 * height / 2)); bubblePath.lineTo((x = width - ARROW_HEIGHT), (y =
			 * height / 2 + ARROW_WIDTH)); bubblePath.lineTo(x, (y = height));
			 * bubblePath.lineTo((x = 0), y); bubblePath.close(); } break; case
			 * RIGHT: { bubblePath.moveTo((x = ARROW_HEIGHT), y);
			 * bubblePath.lineTo((x = width), y); bubblePath.lineTo(x, (y =
			 * height)); bubblePath.lineTo((x = ARROW_HEIGHT), y);
			 * bubblePath.lineTo(x, (y = height / 2 + ARROW_WIDTH));
			 * bubblePath.lineTo((x = 0), (y = height / 2));
			 * bubblePath.lineTo((x = ARROW_HEIGHT), (y = height / 2 -
			 * ARROW_WIDTH)); bubblePath.close(); } break; }
			 */
		}
