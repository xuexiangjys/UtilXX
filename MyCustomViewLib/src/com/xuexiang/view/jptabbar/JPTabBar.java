...
import com.xuexiang.view.jptabbar.anno.NorIcons;
import com.xuexiang.view.jptabbar.anno.SeleIcons;
import com.xuexiang.view.jptabbar.anno.Titles;
...
public class JPTabBar extends LinearLayout implements ViewPager.OnPageChangeListener {
    ...
    public JPTabBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }
