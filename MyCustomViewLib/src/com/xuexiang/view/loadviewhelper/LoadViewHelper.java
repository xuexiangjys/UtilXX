package com.xuexiang.view.loadviewhelper;
...
import com.xuexiang.view.loadviewhelper.helper.IVaryViewHelper;
import com.xuexiang.view.loadviewhelper.helper.OnLoadViewListener;
import com.xuexiang.view.loadviewhelper.helper.VaryViewHelperX;

/**
 * Created by yangc on 2017/4/30. E-Mail:yangchaojiang@outlook.com Deprecated:
	...
	public void showError(String errorText, String buttonText) {
		if (loadError == null) {
			if (builder.loadError == 0) {
				loadError = helper.inflate(R.layout.layout_load_error);
				if (errorText != null) {
	...
	public void showEmpty(String errorText, String buttonText) {
		if (loadEmpty == null) {
			if (builder.loadEmpty == 0) {
				loadEmpty = helper.inflate(R.layout.layout_load_empty);
				if (errorText != null) {
	...
	public void showLoading(String loadText) {
		if (loadIng == null) {
			if (builder.loadIng == 0) {
				loadIng = helper.inflate(R.layout.layout_load_ing);
