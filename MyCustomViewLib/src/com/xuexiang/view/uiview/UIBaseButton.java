...
public class UIBaseButton extends Button {
	...
	protected void init(final Context context, final AttributeSet attrs) {
		...
		mShapeType = typedArray.getInt(R.styleable.UIButton_UB_shape_type, SHAPE_TYPE_RECTANGLE);
		...
		int unpressedColor = typedArray.getColor(R.styleable.UIButton_UB_color_unpressed, Color.TRANSPARENT);
		typedArray.recycle();
