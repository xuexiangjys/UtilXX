...
public class UIRippleButton extends UIBaseButton {
	...
	protected void init(final Context context, final AttributeSet attrs) {
		...
		mRippleColor = typedArray.getColor(R.styleable.UIButton_UB_ripple_color, getResources().getColor(R.color.ripple_color));
		mRippleAlpha = typedArray.getInteger(R.styleable.UIButton_UB_ripple_alpha, RIPPLR_ALPHA);
		mRippleDuration = typedArray.getInteger(R.styleable.UIButton_UB_ripple_duration, 1000);
		mShapeType = typedArray.getInt(R.styleable.UIButton_UB_shape_type, 1);
		mRoundRadius = typedArray.getDimensionPixelSize(R.styleable.UIButton_UB_radius, getResources().getDimensionPixelSize(R.dimen.ui_radius));
		typedArray.recycle();
