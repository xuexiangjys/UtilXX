...
/**
 * author：luck project：EasyIndicator package：com.luck.indicator
 * email：893855882@qq.com data：2017/4/1 GitHub： https://github.com/LuckSiege
 */
...
public class EasyIndicator extends LinearLayout implements View.OnClickListener, ViewPager.OnPageChangeListener {
	...
	private void init(TypedArray a) {
		...
		indicator_bottom_line_color = a.getColor(R.styleable.EasyIndicator_indicator_bottom_line_color, Color.rgb(238, 238, 238));
		// indicator_selected_color
		indicator_selected_color = a.getColor(R.styleable.EasyIndicator_indicator_selected_color, Color.rgb(255, 87, 46));
		// indicator_normal_color
		indicator_normal_color = a.getColor(R.styleable.EasyIndicator_indicator_normal_color, Color.rgb(112, 112, 112));
		// indicator_line_color
		indicator_line_color = a.getColor(R.styleable.EasyIndicator_indicator_line_color, Color.rgb(255, 87, 46));
		// indicator_textSize
		...
		indicator_vertical_line_color = a.getColor(R.styleable.EasyIndicator_indicator_vertical_line_color, indicator_vertical_line_color);
	...
	public void setViewPage(FragmentPagerAdapter adapter) {
		...
		viewPager.setId(R.id.easy_indicator_viewpaper);
	...
	public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
		LinearLayout.LayoutParams ll = (android.widget.LinearLayout.LayoutParams) indicator.getLayoutParams();
