package com.xuexiang.view.indicatordialog;

import static com.xuexiang.view.indicatordialog.IndicatorBuilder.TOP;
...
public class IndicatorDialog {
    ...
    private void addRecyclerView2RecyclerView() {
        childLayout = (LinearLayout) LayoutInflater.from(mContext).inflate(R.layout.dialog_indicator_layout, rootLayout, true);
    ...
    private void resizeHeight(int recyclerviewHeight) {
        ...
        int topAndBottomHeight = DisplayUtils.dip2px(mContext, 10);
        ...
        if (mBuilder.arrowdirection == IndicatorBuilder.BOTTOM) {
            ...
            params1.bottomMargin = arrowWidth + DisplayUtils.dip2px(mContext, 5);
            recyclerView.setLayoutParams(params1);
        } else {
            RelativeLayout.LayoutParams params1 = (RelativeLayout.LayoutParams) recyclerView.getLayoutParams();
            params1.bottomMargin = DisplayUtils.dip2px(mContext, 5);
            recyclerView.setLayoutParams(params1);
        }
