...
public class UpLoadRepairPicture extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		{	
			...
			// 设置文件上传路径
			String uploadPath = this.getServletContext().getRealPath("/User/RepairInfo/");
		...
		try {
			repairInfo = (RepairInfo)JsonUtil.fromRequest(jsonstr, RepairInfo.class);
		} catch (Exception e) {
