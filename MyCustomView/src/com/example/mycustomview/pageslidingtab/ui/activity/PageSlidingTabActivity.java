package com.example.mycustomview.pageslidingtab.ui.activity;
...
import com.example.mycustomview.pageslidingtab.ui.adapter.PageSlidingTabPagerAdapter;
import com.xuexiang.view.pageslidingtab.PagerSlidingTab;

public class PageSlidingTabActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pageslidingtab);
        initView();
        initActionBar();
    }
    ...
    private void initView(){
        ...
        viewPager.setAdapter(new PageSlidingTabPagerAdapter(getSupportFragmentManager()));
