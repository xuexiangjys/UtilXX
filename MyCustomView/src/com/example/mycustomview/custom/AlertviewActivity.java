...
import com.xuexiang.view.alertview.AlertView;
import com.xuexiang.view.alertview.OnDismissListener;
import com.xuexiang.view.alertview.OnItemClickListener;

/**
 * 精仿iOSAlertViewController控件Demo
 */
public class AlertviewActivity extends BaseHeadActivity implements OnItemClickListener, OnDismissListener {
	...
	public void alertShow3(View view) {
		new AlertView(null, null, null, new String[] { "高亮按钮1", "高亮按钮2", "高亮按钮3" }, new String[] { "其他按钮1", "其他按钮2", "其他按钮3", "其他按钮4", "其他按钮5", "其他按钮6", "其他按钮7", "其他按钮8", "其他按钮9", "其他按钮10", "其他按钮11",
				"其他按钮12" }, this, AlertView.Style.Alert, this).show();
	}
