...
import com.xuexiang.view.custom.LoadingLayout;
...
public class LoadingLayoutActivity extends AppCompatActivity implements View.OnClickListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_loadinglayout);

        vLoading = LoadingLayout.wrap(this);
        vLoading.setRetryListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(v.getContext(), "重新加载" , Toast.LENGTH_LONG).show();
            }
        });
        vLoading.showContent();

        findViewById(R.id.loadingactivity).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
