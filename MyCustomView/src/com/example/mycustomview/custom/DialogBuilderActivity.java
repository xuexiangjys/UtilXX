...
import com.xuexiang.view.dialog.dialogbuilder.DialogInterface;
import com.xuexiang.view.dialog.dialogbuilder.MDAlertDialog;
import com.xuexiang.view.dialog.dialogbuilder.MDEditDialog;
import com.xuexiang.view.dialog.dialogbuilder.MDSelectionDialog;
import com.xuexiang.view.dialog.dialogbuilder.NormalAlertDialog;
import com.xuexiang.view.dialog.dialogbuilder.NormalSelectionDialog;

@SuppressLint("ResourceAsColor") 
public class DialogBuilderActivity extends BaseHeadActivity implements View.OnClickListener {
	...
	protected int getLayoutId() {
		return R.layout.activity_dialogbuilder;
	}
    ...
    private void initNormalDialog() {
        ...
        new NormalAlertDialog.Builder(DialogBuilderActivity.this).setTitleVisible(false)
                .setTitleText("温馨提示")
    ...
    private void initNormalDialog2() {
        ...
        new NormalAlertDialog.Builder(DialogBuilderActivity.this).setHeight(0.23f)  //屏幕高度*0.23
    ...
    private void initMDDialog() {
        ...
        new MDAlertDialog.Builder(DialogBuilderActivity.this)
    ...
    private void initMDMidDialog() {
        ...
        new MDSelectionDialog.Builder(DialogBuilderActivity.this)
                .setCanceledOnTouchOutside(true)
    ...
    private void initMDEditDialog() {
        ...
        new MDEditDialog.Builder(DialogBuilderActivity.this).setTitleVisible(true)
                .setTitleText("修改用户名")
                .setTitleTextSize(20)
                .setTitleTextColor(R.color.black_light)
