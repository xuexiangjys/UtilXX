...
import com.example.mycustomview.supertextview.adapter.NewsAdapter;
import com.example.mycustomview.supertextview.bean.NewsBean;
import com.zhy.adapter.recyclerview.MultiItemTypeAdapter;

/**
 * Created by allen on 2016/10/31. 列表中使用
 */

public class SuperListActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
	private RecyclerView recyclerView;
	private SwipeRefreshLayout swipeRefreshLayout;
	private NewsAdapter adapter;
	private List<NewsBean> newsBeanList = new ArrayList<>();

	private String[] url = new String[] { "https://ss0.baidu.com/6ONWsjip0QIZ8tyhnq/it/u=1580482776,3214289843&fm=80&w=179&h=119&img.JPEG",
			...
			"https://ss1.baidu.com/6ONXsjip0QIZ8tyhnq/it/u=2218526845,522933158&fm=80&w=179&h=119&img.JPEG", "https://ss0.baidu.com/6ONWsjip0QIZ8tyhnq/it/u=775731846,1370921386&fm=80",
	...
	protected void onCreate(@Nullable Bundle savedInstanceState) {
		...
		adapter.setOnItemClickListener(new MultiItemTypeAdapter.OnItemClickListener() {
			...
			public void onItemClick(View view, RecyclerView.ViewHolder holder, int position) {
				Toast.makeText(SuperListActivity.this, position + "", Toast.LENGTH_SHORT).show();
			}
