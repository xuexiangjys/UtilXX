...
public class TagShapeActivity extends BaseHeadActivity implements TagView.OnTagClickListener, TagView.OnTagLongClickListener {
	...
	protected int getLayoutId() {
		return R.layout.activity_tag_shape;
	}
