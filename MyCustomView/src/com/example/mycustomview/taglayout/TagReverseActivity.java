...
public class TagReverseActivity extends BaseHeadActivity implements TagView.OnTagClickListener, TagView.OnTagLongClickListener {
	...
	protected int getLayoutId() {
		return R.layout.activity_tag_reverse;
	}
