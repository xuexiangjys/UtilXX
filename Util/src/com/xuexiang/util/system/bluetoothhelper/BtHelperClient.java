...
//    private OutputStream mAcceptOutputStream;
    ...
    public void searchDevices(OnSearchDeviceListener listener) {
        ...
        if (mBondedList == null) mBondedList = new ArrayList<BluetoothDevice>();
        if (mNewList == null) mNewList = new ArrayList<BluetoothDevice>();
    ...
    private Queue<MessageItem> mMessageQueue = new LinkedBlockingQueue<MessageItem>();
