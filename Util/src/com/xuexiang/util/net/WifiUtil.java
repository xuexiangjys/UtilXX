...
public class WifiUtil {
	...
	public void startWifiAp(Context context, String wifiAP_ssid,
			String wifiAP_password) {
		...
		try {
			...
			WifiConfiguration netConfig = getConfig(wifiAP_ssid,
					wifiAP_password);
	...
	public void stopWifiAp(Context context, String wifiAP_ssid,
			String wifiAP_password) {
		WifiManager wifiManager = (WifiManager) context
				.getSystemService(Context.WIFI_SERVICE);
		Method method1 = null;
	...
	public WifiConfiguration getConfig(String wifiAP_ssid,
			String wifiAP_password) {
		...
		netConfig.allowedKeyManagement.set(securityType);// WifiConfiguration.KeyMgmt.WPA_PSK
	...
	public int getValue(String attributeName) {
		int securityType = 0;
		try {
			securityType = (Integer) (KeyMgmt.class.getField("WPA2_PSK")
					.get(null));
		} catch (IllegalArgumentException e) {
			e.printStackTrace();
		} catch (IllegalAccessException e) {
	...
	public static boolean checkSSIDState(Context context, String ssid) {
		...
		try {
			info = (WifiConfiguration) wifiManager.getClass()
					.getMethod("getWifiApConfiguration").invoke(wifiManager);
		} catch (IllegalArgumentException e) {
