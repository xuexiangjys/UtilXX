...
/**
 * Created by soulrelay on 2016/10/11 13:42. Class Note: use this class to load
...
public class ImageLoaderUtil {
	...
	/**
	 * 统一使用App context
	 * 可能带来的问题：http://stackoverflow.com/questions/31964737/glide-
	 * image-loading-with-application-context
	 * 
	 * @param url
	 * @param placeholder
	 * @param imageView
	...
	/**
	 * 需要展示图片加载进度的请参考 GalleryAdapter 样例如下所示
	 */
