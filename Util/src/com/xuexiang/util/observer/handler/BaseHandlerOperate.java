package com.xuexiang.util.observer.handler;

import java.util.ArrayList;

import com.xuexiang.util.observer.handler.BaseHandler.BaseHandlerGetKey;
 ...
 * 
 */
public class BaseHandlerOperate implements BaseHandlerGetKey, FactoryOperateInterface {
	// 当前操作的对象class
	 ...
	 */
	public BaseHandlerOperate addKeyHandler(Class<?> clazz, BaseHandlerUpDate handlerUpDate) {
		if (null != clazz) {
