package com.xuexiang.app.activityswitcher;
...
class ActivitySwitcherHelper {
    ...
    public ActivitySwitcherHelper(ActivitySwitcher switcher, Application application) {
        ...
        flingActivities = new ArrayList<Activity>();
