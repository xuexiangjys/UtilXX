...
public class UpdateUtil {
	private static final String TAG = "utilxx.update";
	private static final String PREFS = "utilxx.update.prefs";
	private static final String KEY_IGNORE = "utilxx.update.prefs.ignore";
	private static final String KEY_UPDATE = "utilxx.update.prefs.update";
