...
public class LoadingButton extends View{
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mCommonDrawable = ResourceUtils.getImageDrawableFromAssets(context, "download_text.png");
        mCompleteDrawable = ResourceUtils.getImageDrawableFromAssets(context, "complete.png");
