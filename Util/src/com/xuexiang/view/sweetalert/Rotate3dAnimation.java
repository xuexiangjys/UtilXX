...
public class Rotate3dAnimation extends Animation {
    ...
    public Rotate3dAnimation (Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, RUtils.getStyleable(context, "Rotate3dAnimation"));

        mFromDegrees = a.getFloat(RUtils.getStyleableAttribute(context, "Rotate3dAnimation_fromDeg"), 0.0f);
        mToDegrees = a.getFloat(RUtils.getStyleableAttribute(context, "Rotate3dAnimation_toDeg"), 0.0f);
        mRollType = a.getInt(RUtils.getStyleableAttribute(context, "Rotate3dAnimation_rollType"), ROLL_BY_X);
        Description d = parseValue(a.peekValue(RUtils.getStyleableAttribute(context, "Rotate3dAnimation_pivotX")));
        mPivotXType = d.type;
        mPivotXValue = d.value;

        d = parseValue(a.peekValue(RUtils.getStyleableAttribute(context, "Rotate3dAnimation_pivotY")));
        mPivotYType = d.type;
