...
public class ProgressHelper {
    ...
    public ProgressHelper(Context context) {
        mToSpin = true;
        mSpinSpeed = 0.75f;
        mBarWidth = context.getResources().getDimensionPixelSize(RUtils.getDimen(context, "common_circle_width")) + 1;
        mBarColor = context.getResources().getColor(RUtils.getColor(context, "success_stroke_color"));
        mRimWidth = 0;
        mRimColor = 0x00000000;
        mIsInstantProgress = false;
        mProgressVal = -1;
        mCircleRadius = context.getResources().getDimensionPixelOffset(RUtils.getDimen(context, "progress_circle_radius"));
    }
