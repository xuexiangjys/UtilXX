...
public class Utils {
    ...
    public static List<Icon> getIcons(Context context) {
        ...
        icons.add(new Icon(RUtils.getDrawable(context, "heart_on"), RUtils.getDrawable(context, "heart_off"), IconType.Heart));
        icons.add(new Icon(RUtils.getDrawable(context, "star_on"), RUtils.getDrawable(context, "star_off"), IconType.Star));
        icons.add(new Icon(RUtils.getDrawable(context, "thumb_on"), RUtils.getDrawable(context, "thumb_off"), IconType.Thumb));
