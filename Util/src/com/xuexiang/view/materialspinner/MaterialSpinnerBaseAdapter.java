...
public abstract class MaterialSpinnerBaseAdapter<T> extends BaseAdapter {
  ...
  @Override public View getView(int position, View convertView, ViewGroup parent) {
    ...
    if (convertView == null) {
      ...
      convertView = inflater.inflate(RUtils.getLayout(context, "ms__list_item"), parent, false);
      textView = (TextView) convertView.findViewById(RUtils.getId(context, "tv_tinted_spinner"));
