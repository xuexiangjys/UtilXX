package com.xuexiang.view.uipicker.blur;
...
public class PickerUIBlurHelper {
    ...
    private void getAttributes(AttributeSet attrs) {
        ...
        if (typedArray != null) {
            try {
                mUseBlur = typedArray.getBoolean(MResource.getIdByName(mContext, "styleable", "PickerUI_blur"),
                        PickerUIBlur.DEFAULT_USE_BLUR);
                mBlurRadius = typedArray.getInteger(MResource.getIdByName(mContext, "styleable", "PickerUI_blur_radius"),
                        PickerUIBlur.DEFAULT_BLUR_RADIUS);
                mDownScaleFactor = typedArray.getFloat(MResource.getIdByName(mContext, "styleable", "PickerUI_blur_downScaleFactor"),
                        PickerUIBlur.DEFAULT_DOWNSCALE_FACTOR);
                mFilterColor = typedArray.getColor(MResource.getIdByName(mContext, "styleable", "PickerUI_blur_FilterColor"), -1);
                mUseRenderScript = typedArray.getBoolean(MResource.getIdByName(mContext, "styleable", "PickerUI_blur_use_renderscript"),
