...
class PickerUIAdapter extends ArrayAdapter<String> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = vi.inflate(RUtils.getLayout(mContext, "pickerui_item"), parent, false);
        }

        TextView textItem = ViewHolder.get(convertView, RUtils.getId(mContext, "tv_item"));
    ...
    private void setTextItemStyle(TextView textItem, int position) {
        ...
        if (position == centerPosition) {
            textItem.setTextAppearance(mContext, RUtils.getStyle(mContext, "PickerUI_Center_Item"));
            ...
            textItem.setTextAppearance(mContext, RUtils.getStyle(mContext, "PickerUI_Near_Center_Item"));
            setTextNoCenterColor(textItem);
            textItem.setRotationX(ROTATION_TWICE_ABOVE);
            textItem.setAlpha((float) 1.0);
        } else if (position - 2 == centerPosition) {
            textItem.setTextAppearance(mContext, RUtils.getStyle(mContext, "PickerUI_Far_Center_Item"));
            setTextNoCenterColor(textItem);
            ...
            textItem.setTextAppearance(mContext, RUtils.getStyle(mContext, "PickerUI_Small_Item"));
        }
    }
