...
class PickerUIListView extends ListView {
    ...
    private void createEditModeView(Context context) {
        ...
        mPickerUIAdapter = new PickerUIAdapter(context,RUtils.getLayout(getContext(), "pickerui_item"), entriesList,
    ...
    public void setItems(Context context, List<String> items, int idRequestPickerUI, int position,
        ...
        mPickerUIAdapter = new PickerUIAdapter(context, RUtils.getLayout(getContext(), "pickerui_item"), items, position,
