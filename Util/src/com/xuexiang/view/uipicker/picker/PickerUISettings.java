...
public class PickerUISettings implements Parcelable {
    ...
    public static final class Builder {
        ...
        public Builder(Context context) {
        	mContext = context;
        	mColorTextCenter = RUtils.getColor(mContext, "text_center_pickerui");
        	mColorTextNoCenter = RUtils.getColor(mContext, "text_no_center_pickerui");
        	mBackgroundColor = RUtils.getColor(mContext, "background_panel_pickerui");
        	mLinesColor = RUtils.getColor(mContext, "lines_panel_pickerui");
        }
