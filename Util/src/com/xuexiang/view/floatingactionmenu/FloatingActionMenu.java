package com.xuexiang.view.floatingactionmenu;
...
public class FloatingActionMenu extends ViewGroup {
    ...
    private void init(Context context, AttributeSet attrs) {
        TypedArray attr = context.obtainStyledAttributes(attrs, RUtils.getStyleable(context, "FloatingActionMenu"), 0, 0);
        mButtonSpacing = attr.getDimensionPixelSize(MResource.getIdByName(context, "styleable", "FloatingActionMenu_menu_buttonSpacing"), mButtonSpacing);
        mLabelsMargin = attr.getDimensionPixelSize(MResource.getIdByName(context, "styleable", "FloatingActionMenu_menu_labels_margin"), mLabelsMargin);
        mLabelsPosition = attr.getInt(MResource.getIdByName(context, "styleable", "FloatingActionMenu_menu_labels_position"), LABELS_POSITION_LEFT);
        mLabelsShowAnimation = attr.getResourceId(MResource.getIdByName(context, "styleable", "FloatingActionMenu_menu_labels_showAnimation"),
                mLabelsPosition == LABELS_POSITION_LEFT ? RUtils.getAnim(context, "fab_slide_in_from_right") : RUtils.getAnim(context, "fab_slide_in_from_left"));
        mLabelsHideAnimation = attr.getResourceId(MResource.getIdByName(context, "styleable", "FloatingActionMenu_menu_labels_hideAnimation"),
                mLabelsPosition == LABELS_POSITION_LEFT ? RUtils.getAnim(context, "fab_slide_out_to_right") : RUtils.getAnim(context, "fab_slide_out_to_left"));
        mLabelsPaddingTop = attr.getDimensionPixelSize(MResource.getIdByName(context, "styleable", "FloatingActionMenu_menu_labels_paddingTop"), mLabelsPaddingTop);
        mLabelsPaddingRight = attr.getDimensionPixelSize(MResource.getIdByName(context, "styleable", "FloatingActionMenu_menu_labels_paddingRight"), mLabelsPaddingRight);
        mLabelsPaddingBottom = attr.getDimensionPixelSize(MResource.getIdByName(context, "styleable", "FloatingActionMenu_menu_labels_paddingBottom"), mLabelsPaddingBottom);
        mLabelsPaddingLeft = attr.getDimensionPixelSize(MResource.getIdByName(context, "styleable", "FloatingActionMenu_menu_labels_paddingLeft"), mLabelsPaddingLeft);
        mLabelsTextColor = attr.getColorStateList(MResource.getIdByName(context, "styleable", "FloatingActionMenu_menu_labels_textColor"));
        ...
        mLabelsTextSize = attr.getDimension(MResource.getIdByName(context, "styleable", "FloatingActionMenu_menu_labels_textSize"), getResources().getDimension(RUtils.getDimen(getContext(), "labels_text_size")));
        mLabelsCornerRadius = attr.getDimensionPixelSize(MResource.getIdByName(context, "styleable", "FloatingActionMenu_menu_labels_cornerRadius"), mLabelsCornerRadius);
        mLabelsShowShadow = attr.getBoolean(MResource.getIdByName(context, "styleable", "FloatingActionMenu_menu_labels_showShadow"), true);
        mLabelsColorNormal = attr.getColor(MResource.getIdByName(context, "styleable", "FloatingActionMenu_menu_labels_colorNormal"), 0xFF333333);
        mLabelsColorPressed = attr.getColor(MResource.getIdByName(context, "styleable", "FloatingActionMenu_menu_labels_colorPressed"), 0xFF444444);
        mLabelsColorRipple = attr.getColor(MResource.getIdByName(context, "styleable", "FloatingActionMenu_menu_labels_colorRipple"), 0x66FFFFFF);
        mMenuShowShadow = attr.getBoolean(MResource.getIdByName(context, "styleable", "FloatingActionMenu_menu_showShadow"), true);
        mMenuShadowColor = attr.getColor(MResource.getIdByName(context, "styleable", "FloatingActionMenu_menu_shadowColor"), 0x66000000);
        mMenuShadowRadius = attr.getDimension(MResource.getIdByName(context, "styleable", "FloatingActionMenu_menu_shadowRadius"), mMenuShadowRadius);
        mMenuShadowXOffset = attr.getDimension(MResource.getIdByName(context, "styleable", "FloatingActionMenu_menu_shadowXOffset"), mMenuShadowXOffset);
        mMenuShadowYOffset = attr.getDimension(MResource.getIdByName(context, "styleable", "FloatingActionMenu_menu_shadowYOffset"), mMenuShadowYOffset);
        mMenuColorNormal = attr.getColor(MResource.getIdByName(context, "styleable", "FloatingActionMenu_menu_colorNormal"), 0xFFDA4336);
        mMenuColorPressed = attr.getColor(MResource.getIdByName(context, "styleable", "FloatingActionMenu_menu_colorPressed"), 0xFFE75043);
        mMenuColorRipple = attr.getColor(MResource.getIdByName(context, "styleable", "FloatingActionMenu_menu_colorRipple"), 0x99FFFFFF);
        mAnimationDelayPerItem = attr.getInt(MResource.getIdByName(context, "styleable", "FloatingActionMenu_menu_animationDelayPerItem"), 50);
        mIcon = attr.getDrawable(MResource.getIdByName(context, "styleable", "FloatingActionMenu_menu_icon"));
        if (mIcon == null) {
            mIcon = getResources().getDrawable(RUtils.getDrawable(getContext(), "fab_add"));
        }
        mLabelsSingleLine = attr.getBoolean(MResource.getIdByName(context, "styleable", "FloatingActionMenu_menu_labels_singleLine"), false);
        mLabelsEllipsize = attr.getInt(MResource.getIdByName(context, "styleable", "FloatingActionMenu_menu_labels_ellipsize"), 0);
        mLabelsMaxLines = attr.getInt(MResource.getIdByName(context, "styleable", "FloatingActionMenu_menu_labels_maxLines"), -1);
        mMenuFabSize = attr.getInt(MResource.getIdByName(context, "styleable", "FloatingActionMenu_menu_fab_size"), FloatingActionButton.SIZE_NORMAL);
        mLabelsStyle = attr.getResourceId(MResource.getIdByName(context, "styleable", "FloatingActionMenu_menu_labels_style"), 0);
        String customFont = attr.getString(MResource.getIdByName(context, "styleable", "FloatingActionMenu_menu_labels_customFont"));
        try {
        ...
        mOpenDirection = attr.getInt(MResource.getIdByName(context, "styleable", "FloatingActionMenu_menu_openDirection"), OPEN_UP);
        mBackgroundColor = attr.getColor(MResource.getIdByName(context, "styleable", "FloatingActionMenu_menu_backgroundColor"), Color.TRANSPARENT);

        if (attr.hasValue(MResource.getIdByName(context, "styleable", "FloatingActionMenu_menu_fab_label"))) {
            mUsingMenuLabel = true;
            mMenuLabelText = attr.getString(MResource.getIdByName(context, "styleable", "FloatingActionMenu_menu_fab_label"));
        }

        if (attr.hasValue(MResource.getIdByName(context, "styleable", "FloatingActionMenu_menu_labels_padding"))) {
            int padding = attr.getDimensionPixelSize(MResource.getIdByName(context, "styleable", "FloatingActionMenu_menu_labels_padding"), 0);
            initPadding(padding);
        }
    ...
    private void initMenuButtonAnimations(TypedArray attr) {
        int showResId = attr.getResourceId(MResource.getIdByName(getContext(), "styleable", "FloatingActionMenu_menu_fab_show_animation"), RUtils.getAnim(getContext(), "fab_scale_up"));
        ...
        int hideResId = attr.getResourceId(MResource.getIdByName(getContext(), "styleable", "FloatingActionMenu_menu_fab_hide_animation"), RUtils.getAnim(getContext(), "fab_scale_down"));
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < mButtonsCount; i++) {
            ...
            Label label = (Label) child.getTag(RUtils.getId(getContext(), "fab_label"));
            if (label != null) {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = mButtonsCount - 1; i >= 0; i--) {
            ...
            View label = (View) fab.getTag(RUtils.getId(getContext(), "fab_label"));
            if (label != null) {
    ...
    private void createLabels() {
        for (int i = 0; i < mButtonsCount; i++) {
            ...
            if (fab.getTag(RUtils.getId(getContext(), "fab_label")) != null) continue;
    ...
    private void addLabel(FloatingActionButton fab) {
        ...
        addView(label);
        fab.setTag(RUtils.getId(getContext(), "fab_label"), label);
    }
                ...
                if (child instanceof FloatingActionButton && child.getVisibility() != GONE) {
                    ...
                    mUiHandler.postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            Label label = (Label) fab.getTag(RUtils.getId(getContext(), "fab_label"));
