...
public class SubActionButton extends FrameLayout {
    ...
    public SubActionButton(Context context, FrameLayout.LayoutParams layoutParams, int theme, Drawable backgroundDrawable, View contentView, FrameLayout.LayoutParams contentParams) {
        ...
        if(backgroundDrawable == null) {
            if(theme == THEME_LIGHT) {
                backgroundDrawable = context.getResources().getDrawable(RUtils.getDrawable(getContext(), "button_sub_action_selector"));
            }
            else if(theme == THEME_DARK) {
                backgroundDrawable = context.getResources().getDrawable(RUtils.getDrawable(getContext(), "button_sub_action_dark_selector"));
            }
            else if(theme == THEME_LIGHTER) {
                backgroundDrawable = context.getResources().getDrawable(RUtils.getDrawable(getContext(), "button_action_selector"));
            }
            else if(theme == THEME_DARKER) {
                backgroundDrawable = context.getResources().getDrawable(RUtils.getDrawable(getContext(), "button_action_dark_selector"));
            }
            else {
    ...
    public void setContentView(View contentView, FrameLayout.LayoutParams params) {
        if(params == null) {
            ...
            final int margin = getResources().getDimensionPixelSize(RUtils.getDimen(getContext(), "sub_action_button_content_margin"));
    ...
    public static class Builder {
        ...
        public Builder(Context context) {
            ...
            int size = context.getResources().getDimensionPixelSize(RUtils.getDimen(context, "sub_action_button_size"));
