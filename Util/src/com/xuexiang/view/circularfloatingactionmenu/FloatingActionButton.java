...
public class FloatingActionButton extends FrameLayout {
    ...
    public void setPosition(int position, ViewGroup.LayoutParams layoutParams) {
        ...
        if(!systemOverlay) {
            ...
            try {
                ...
                lp.gravity = gravity;
                if(setDefaultMargin) {
                    int margin =  getContext().getResources().getDimensionPixelSize(RUtils.getDimen(getContext(), "action_button_margin"));
                    lp.x = margin;
                    lp.y = margin;
                }
                setLayoutParams(lp);
    ...
    public void setContentView(View contentView, FrameLayout.LayoutParams contentParams) {
        ...
        if(contentParams == null ){
            ...
            final int margin = getResources().getDimensionPixelSize(RUtils.getDimen(getContext(), "action_button_content_margin"));
    ...
    public static class Builder {
        ...
        public Builder(Context context) {
            ...
            int size = context.getResources().getDimensionPixelSize(RUtils.getDimen(context, "action_button_size"));
            int margin = context.getResources().getDimensionPixelSize(RUtils.getDimen(context, "action_button_margin"));
