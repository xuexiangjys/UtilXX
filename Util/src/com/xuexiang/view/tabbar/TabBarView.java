package com.xuexiang.view.tabbar;
...
public class TabBarView extends RelativeLayout implements View.OnClickListener, View.OnTouchListener {
	...
	public TabBarView(Context context, AttributeSet attrs) {
		...
		inflater.inflate(RUtils.getLayout(getContext(), "widget_tabbar"), this, true);
		initView();
		initListener();
	...
	private void initView() {
		tabBackView = (TabMainView) findViewById(RUtils.getId(getContext(), "tabBackView"));
		views[0] = findViewById(RUtils.getId(getContext(), "firstIV"));
		views[1] = findViewById(RUtils.getId(getContext(), "secondIV"));
		views[2] = findViewById(RUtils.getId(getContext(), "centerIV"));
		views[3] = findViewById(RUtils.getId(getContext(), "fourIV"));
		views[4] = findViewById(RUtils.getId(getContext(), "fiveIV"));
		secondlyFirstIV = findViewById(RUtils.getId(getContext(), "secondlyFirstIV"));
		secondlySecondIV = findViewById(RUtils.getId(getContext(), "secondlySecondIV"));
