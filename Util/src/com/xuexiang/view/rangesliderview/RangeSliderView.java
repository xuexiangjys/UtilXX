  ...
  public RangeSliderView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    if (attrs != null) {
      ...
      try {
        ...
        rangeCount = a.getInt(
          MResource.getIdByName(context, "styleable", "RangeSliderView_rangeCount"), DEFAULT_RANGE_COUNT);
        filledColor = a.getColor(
          MResource.getIdByName(context, "styleable", "RangeSliderView_filledColor"), DEFAULT_FILLED_COLOR);
        emptyColor = a.getColor(
          MResource.getIdByName(context, "styleable", "RangeSliderView_emptyColor"), DEFAULT_EMPTY_COLOR);
        barHeightPercent = a.getFloat(
          MResource.getIdByName(context, "styleable", "RangeSliderView_barHeightPercent"), DEFAULT_BAR_HEIGHT_PERCENT);
        barHeightPercent = a.getFloat(
          MResource.getIdByName(context, "styleable", "RangeSliderView_barHeightPercent"), DEFAULT_BAR_HEIGHT_PERCENT);
        slotRadiusPercent = a.getFloat(
          MResource.getIdByName(context, "styleable", "RangeSliderView_slotRadiusPercent"), DEFAULT_SLOT_RADIUS_PERCENT);
        sliderRadiusPercent = a.getFloat(
          MResource.getIdByName(context, "styleable", "RangeSliderView_sliderRadiusPercent"), DEFAULT_SLIDER_RADIUS_PERCENT);
      } finally {
        a.recycle();
        sa.recycle();
      }
