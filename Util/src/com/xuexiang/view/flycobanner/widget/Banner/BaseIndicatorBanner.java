package com.xuexiang.view.flycobanner.widget.Banner;
...
import com.xuexiang.view.flycobanner.widget.Banner.base.BaseBanner;
...
public abstract class BaseIndicatorBanner<E, T extends BaseIndicatorBanner<E, T>> extends BaseBanner<E, T> {
    ...
    private ArrayList<ImageView> mIndicatorViews = new ArrayList<ImageView>();
    ...
    public BaseIndicatorBanner(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, RUtils.getStyleable(context, "BaseIndicatorBanner"));
        mIndicatorStyle = ta.getInt(RUtils.getStyleableAttribute(context, "BaseIndicatorBanner_bb_indicatorStyle"), STYLE_CORNER_RECTANGLE);
        mIndicatorWidth = ta.getDimensionPixelSize(RUtils.getStyleableAttribute(context, "BaseIndicatorBanner_bb_indicatorWidth"), dp2px(6));
        mIndicatorHeight = ta.getDimensionPixelSize(RUtils.getStyleableAttribute(context, "BaseIndicatorBanner_bb_indicatorHeight"), dp2px(6));
        mIndicatorGap = ta.getDimensionPixelSize(RUtils.getStyleableAttribute(context, "BaseIndicatorBanner_bb_indicatorGap"), dp2px(6));
        mIndicatorCornerRadius = ta.getDimensionPixelSize(RUtils.getStyleableAttribute(context, "BaseIndicatorBanner_bb_indicatorCornerRadius"), dp2px(3));
        mSelectColor = ta.getColor(RUtils.getStyleableAttribute(context, "BaseIndicatorBanner_bb_indicatorSelectColor"), Color.parseColor("#ffffff"));
        mUnselectColor = ta.getColor(RUtils.getStyleableAttribute(context, "BaseIndicatorBanner_bb_indicatorUnselectColor"), Color.parseColor("#88ffffff"));

        int selectRes = ta.getResourceId(RUtils.getStyleableAttribute(context, "BaseIndicatorBanner_bb_indicatorSelectRes"), 0);
        int unselectRes = ta.getResourceId(RUtils.getStyleableAttribute(context, "BaseIndicatorBanner_bb_indicatorUnselectRes"), 0);
        ta.recycle();
