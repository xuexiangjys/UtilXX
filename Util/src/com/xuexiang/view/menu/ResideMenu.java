...
public class ResideMenu extends FrameLayout {
	...
	private void initViews(Context context) {
		...
		inflater.inflate(RUtils.getLayout(context, "residemenu"), this);
		leftMenu = (RelativeLayout) findViewById(RUtils.getId(context, "rl_left_menu"));
		rightMenu = (RelativeLayout) findViewById(RUtils.getId(context, "rl_right_menu"));
		imageViewShadow = (ImageView) findViewById(RUtils.getId(context, "iv_shadow"));
		layoutLeftMenu = (LinearLayout) findViewById(RUtils.getId(context, "layout_left_menu"));
		layoutRightMenu = (LinearLayout) findViewById(RUtils.getId(context, "layout_right_menu"));
		imageViewBackground = (ImageView) findViewById(RUtils.getId(context, "iv_background"));

		layoutInfo = (LinearLayout) findViewById(RUtils.getId(context, "layout_info"));

		layoutSetting = (LinearLayout) findViewById(RUtils.getId(context, "layout_setting"));
	}
	...
	public void setShadowVisible(boolean isVisible) {
		if (isVisible)
			imageViewShadow.setImageBitmap(ResourceUtils.getImageFromAssets(getContext(), "shadow.9.png"));
		else
