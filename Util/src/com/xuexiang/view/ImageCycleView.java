 ...
 *   使用：只需在xml文件中使用{@code <com.xuexiang.view.ImageCycleView/>} ，
...
public class ImageCycleView extends LinearLayout {
	...
	public ImageCycleView(Context context, AttributeSet attrs) {
		...
		LayoutInflater.from(context).inflate(RUtils.getLayout(getContext(), "ad_cycle_view"), this);
		mAdvPager = (ViewPager) findViewById(RUtils.getId(getContext(), "adv_pager"));
		...
		// 滚动图片右下指示器视图
		mGroup = (ViewGroup) findViewById(RUtils.getId(getContext(), "viewGroup"));
	}
	...
	public void setImageResources(ArrayList<String> imageUrlList, ImageCycleViewListener imageCycleViewListener) {
		...
		for (int i = 0; i < imageCount; i++) {
			...
			if (i == 0) {
				mImageViews[i].setImageBitmap(ResourceUtils.getImageFromAssets(getContext(), "home_img_ratio_selected.png"));
			} else {
				mImageViews[i].setImageBitmap(ResourceUtils.getImageFromAssets(getContext(), "home_img_ratio.png"));
			}
	...
	private final class GuidePageChangeListener implements OnPageChangeListener {
		...
		public void onPageSelected(int index) {
			...
			mImageIndex = index;
			// 设置图片滚动指示器背景
			mImageViews[index].setImageBitmap(ResourceUtils.getImageFromAssets(getContext(), "home_img_ratio_selected.png"));
