...
public class SwipeListView extends ListView {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray styled = getContext().obtainStyledAttributes(attrs, RUtils.getStyleable(getContext(), "SwipeListView"));
            swipeMode = styled.getInt(MResource.getIdByName(getContext(), "styleable", "SwipeListView_swipeMode"), SWIPE_MODE_BOTH);
            swipeActionLeft = styled.getInt(MResource.getIdByName(getContext(), "styleable", "SwipeListView_swipeActionLeft"), SWIPE_ACTION_REVEAL);
            swipeActionRight = styled.getInt(MResource.getIdByName(getContext(), "styleable", "SwipeListView_swipeActionRight"), SWIPE_ACTION_REVEAL);
            swipeOffsetLeft = styled.getDimension(MResource.getIdByName(getContext(), "styleable", "SwipeListView_swipeOffsetLeft"), 0);
            swipeOffsetRight = styled.getDimension(MResource.getIdByName(getContext(), "styleable", "SwipeListView_swipeOffsetRight"), 0);
            swipeOpenOnLongPress = styled.getBoolean(MResource.getIdByName(getContext(), "styleable", "SwipeListView_swipeOpenOnLongPress"), true);
            swipeAnimationTime = styled.getInteger(MResource.getIdByName(getContext(), "styleable", "SwipeListView_swipeAnimationTime"), 0);
            swipeCloseAllItemsWhenMoveList = styled.getBoolean(MResource.getIdByName(getContext(), "styleable", "SwipeListView_swipeCloseAllItemsWhenMoveList"), true);
            swipeFrontView = styled.getResourceId(MResource.getIdByName(getContext(), "styleable", "SwipeListView_swipeFrontView"), 0);
            swipeBackView = styled.getResourceId(MResource.getIdByName(getContext(), "styleable", "SwipeListView_swipeBackView"), 0);
        }
