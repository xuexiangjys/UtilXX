...
public class Dialog extends android.app.Dialog{
	...
	@Override
	  protected void onCreate(Bundle savedInstanceState) {
	    ...
	    setContentView(RUtils.getLayout(getContext(), "dialog_main"));
	    ...
	    this.messageTextView = (TextView) findViewById(RUtils.getId(getContext(), "message"));
	    setMessage(message);
	    
	    this.buttonAccept = (ButtonFlat) findViewById(RUtils.getId(getContext(), "button_accept"));
	    ...
	    if(buttonCancelText != null){
		    this.buttonCancel = (ButtonFlat) findViewById(RUtils.getId(getContext(), "button_cancel"));
