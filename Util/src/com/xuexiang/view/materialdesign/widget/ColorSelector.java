...
import com.xuexiang.view.materialdesign.view.Slider;
import com.xuexiang.view.materialdesign.view.Slider.OnValueChangedListener;
...
public class ColorSelector extends android.app.Dialog implements OnValueChangedListener{
	...
	@Override
	  protected void onCreate(Bundle savedInstanceState) {
	    ...
	    setContentView(RUtils.getLayout(getContext(), "color_selector"));
	    
	    view = (LinearLayout)findViewById(RUtils.getId(getContext(), "contentSelector"));
		backView = (RelativeLayout)findViewById(RUtils.getId(getContext(), "rootSelector"));
	    ...
	    colorView = findViewById(RUtils.getId(context, "viewColor"));
	    ...
	    // Configure Sliders
	    red = (Slider) findViewById(RUtils.getId(context, "red"));
	    green = (Slider) findViewById(RUtils.getId(context, "green"));
	    blue = (Slider) findViewById(RUtils.getId(context, "blue"));
