...
public abstract class Button extends CustomView {
	...
	protected void setDefaultProperties() {
		// Min size
		setMinimumHeight(DisplayUtils.dip2px(getContext(), minHeight));
		setMinimumWidth(DisplayUtils.dip2px(getContext(), minWidth));
		// Background shape
	...
	public Bitmap makeCircle() {
		Bitmap output = Bitmap.createBitmap(
				getWidth() - DisplayUtils.dip2px(getContext(), 6), getHeight()
						- DisplayUtils.dip2px(getContext(), 7), Config.ARGB_8888);
