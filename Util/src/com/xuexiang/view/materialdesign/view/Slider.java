...
public class Slider extends CustomView {
            ...
            if (event.getAction() == MotionEvent.ACTION_DOWN
                ...
                if ((event.getX() <= getWidth() && event.getX() >= 0)) {
                    ...
                    if (numberIndicator != null) {
                        ...
                        numberIndicator.indicator.finalY = DisplayUtils
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (value == min) {
            ...
            paint.setStrokeWidth(DisplayUtils.dip2px(getContext(), 2));
    ...
    protected void setAttributes(AttributeSet attrs) {
        ...
        setBackgroundResource(RUtils.getDrawable(getContext(), "background_transparent"));

        // Set size of view
        setMinimumHeight(DisplayUtils.dip2px(getContext(), 48));
        setMinimumWidth(DisplayUtils.dip2px(getContext(), 80));
        ...
        min = attrs.getAttributeIntValue(MATERIALDESIGNXML, "progress_min", 0);
        max = attrs.getAttributeIntValue(MATERIALDESIGNXML, "progress_max", 0);
        value = attrs.getAttributeIntValue(MATERIALDESIGNXML, "value", min);

        ball = new Ball(getContext());
        RelativeLayout.LayoutParams params = new LayoutParams(DisplayUtils.dip2px(getContext(), 20), DisplayUtils.dip2px(getContext(), 20));
    ...
    class Ball extends View {
        ...
        public Ball(Context context) {
            super(context);
            setBackgroundResource(RUtils.getDrawable(getContext(), "background_switch_ball_uncheck"));
        }

        public void changeBackground() {
            if (value != min) {
                setBackgroundResource(RUtils.getDrawable(getContext(), "background_checkbox"));
                LayerDrawable layer = (LayerDrawable) getBackground();
                GradientDrawable shape = (GradientDrawable) layer
                        .findDrawableByLayerId(RUtils.getId(getContext(), "shape_bacground"));
    ...
    class Indicator extends RelativeLayout {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (animate) {
                ...
                y -= DisplayUtils.dip2px(getContext(), 6);
                size += DisplayUtils.dip2px(getContext(), 2);
            }
            canvas.drawCircle(
                    ViewHelper.getX(ball)
                            + DisplayUtils.getRelativeLeft((View) ball.getParent())
            ...
            if (animate == false) {
                ViewHelper
                        .setX(numberIndicator.numberIndicator,
                                (ViewHelper.getX(ball)
                                        + DisplayUtils.getRelativeLeft((View) ball
    ...
    class NumberIndicator extends Dialog {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(RUtils.getLayout(getContext(), "number_indicator_spinner"));
            setCanceledOnTouchOutside(false);

            RelativeLayout content = (RelativeLayout) this
                    .findViewById(RUtils.getId(getContext(), "number_indicator_spinner_content"));
