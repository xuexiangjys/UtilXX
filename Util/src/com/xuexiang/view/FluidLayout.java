...
public class FluidLayout extends ViewGroup {
    ...
    public FluidLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, RUtils.getStyleable(context, "FluidLayout"));
        int index = a.getInt(MResource.getIdByName(context, "styleable", "FluidLayout_gravity"), -1);
        if (index >= 0) {
            setGravity(index);
        }
        a.recycle();
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            ...
            TypedArray a =
                    c.obtainStyledAttributes(attrs, RUtils.getStyleable(c, "FluidLayout_Layout"));
            gravity = a.getInt(MResource.getIdByName(c, "styleable", "FluidLayout_Layout_layout_gravity"), -1);
            a.recycle();
        }
