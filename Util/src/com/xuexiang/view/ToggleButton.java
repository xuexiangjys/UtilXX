...
import com.xuexiang.view.facebook.rebound.SimpleSpringListener;
import com.xuexiang.view.facebook.rebound.Spring;
import com.xuexiang.view.facebook.rebound.SpringConfig;
import com.xuexiang.view.facebook.rebound.SpringSystem;
import com.xuexiang.view.facebook.rebound.SpringUtil;
...
public class ToggleButton extends View{
	...
	public void setup(AttributeSet attrs) {
		...
		TypedArray typedArray = getContext().obtainStyledAttributes(attrs, RUtils.getStyleable(getContext(), "ToggleButton"));
		offBorderColor = typedArray.getColor(RUtils.getStyleableAttribute(getContext(), "ToggleButton_tbOffBorderColor"), offBorderColor);
		onColor = typedArray.getColor(RUtils.getStyleableAttribute(getContext(), "ToggleButton_tbOnColor"), onColor);
		spotColor = typedArray.getColor(RUtils.getStyleableAttribute(getContext(), "ToggleButton_tbSpotColor"), spotColor);
		offColor = typedArray.getColor(RUtils.getStyleableAttribute(getContext(), "ToggleButton_tbOffColor"), offColor);
		borderWidth = typedArray.getDimensionPixelSize(RUtils.getStyleableAttribute(getContext(), "ToggleButton_tbBorderWidth"), borderWidth);
		defaultAnimate = typedArray.getBoolean(RUtils.getStyleableAttribute(getContext(), "ToggleButton_tbAnimate"), defaultAnimate);
		isDefaultOn = typedArray.getBoolean(RUtils.getStyleableAttribute(getContext(), "ToggleButton_tbAsDefaultOn"), isDefaultOn);
		typedArray.recycle();
