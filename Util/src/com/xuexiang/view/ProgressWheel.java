...
public class ProgressWheel extends View {
  ...
  public ProgressWheel(Context context, AttributeSet attrs) {
    ...
    parseAttributes(context.obtainStyledAttributes(attrs, RUtils.getStyleable(context, "ProgressWheel")));
  ...
  private void parseAttributes(TypedArray a) {
    ...
    circleRadius =
        (int) a.getDimension(RUtils.getStyleableAttribute(getContext(), "ProgressWheel_matProg_circleRadius"), circleRadius);

    fillRadius = a.getBoolean(RUtils.getStyleableAttribute(getContext(), "ProgressWheel_matProg_fillRadius"), false);

    barWidth = (int) a.getDimension(RUtils.getStyleableAttribute(getContext(), "ProgressWheel_matProg_barWidth"), barWidth);

    rimWidth = (int) a.getDimension(RUtils.getStyleableAttribute(getContext(), "ProgressWheel_matProg_rimWidth"), rimWidth);

    float baseSpinSpeed =
        a.getFloat(RUtils.getStyleableAttribute(getContext(), "ProgressWheel_matProg_spinSpeed"), spinSpeed / 360.0f);
    spinSpeed = baseSpinSpeed * 360;

    barSpinCycleTime =
        a.getInt(RUtils.getStyleableAttribute(getContext(), "ProgressWheel_matProg_barSpinCycleTime"), (int) barSpinCycleTime);

    barColor = a.getColor(RUtils.getStyleableAttribute(getContext(), "ProgressWheel_matProg_barColor"), barColor);

    rimColor = a.getColor(RUtils.getStyleableAttribute(getContext(), "ProgressWheel_matProg_rimColor"), rimColor);

    linearProgress = a.getBoolean(RUtils.getStyleableAttribute(getContext(), "ProgressWheel_matProg_linearProgress"), false);

    if (a.getBoolean(RUtils.getStyleableAttribute(getContext(), "ProgressWheel_matProg_progressIndeterminate"), false)) {
      spin();
    }
