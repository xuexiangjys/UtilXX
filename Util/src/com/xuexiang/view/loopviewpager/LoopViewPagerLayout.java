...
public class LoopViewPagerLayout extends RelativeLayout implements OnPageChangeListener {
    ...
    private int size = DisplayUtils.dip2px(getContext(), 8);//设置点的大小;
    ...
    public void setLoopData(ArrayList<BannerInfo> bannerInfos, OnBannerItemClickListener onBannerItemClickListener) {
        ...
        for (int i = 0; i < indicators.length; i++) {
            ...
            indicators[i].setBackgroundResource(RUtils.getDrawable(getContext(), "indicator_normal_background"));//设置默认的背景颜色
        ...
        animIndicator.setBackgroundResource(RUtils.getDrawable(getContext(), "indicator_selected_background"));//设置选中的背景颜色
