...
package com.xuexiang.view.snack;
...
public class SnackBar {
    ...
    public SnackBar(Activity activity) {
        ...
        View v = activity.getLayoutInflater().inflate(RUtils.getLayout(activity, "sb_snack"), container, false);
        init(container, v);
    }

    public SnackBar(Context context, View v) {
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        inflater.inflate(RUtils.getLayout(context, "sb_snack_container"), ((ViewGroup) v));
        View snackLayout = inflater.inflate(RUtils.getLayout(context, "sb_snack"), ((ViewGroup) v), false);
        init((ViewGroup) v, snackLayout);
    }

    private void init(ViewGroup container, View v) {
        mSnackContainer = (SnackContainer) container.findViewById(RUtils.getId(container.getContext(), "snackContainer"));
        if (mSnackContainer == null) {
            mSnackContainer = new SnackContainer(container);
        }

        mParentView = v;
        TextView snackBtn = (TextView) v.findViewById(RUtils.getId(container.getContext(), "snackButton"));
    ...
    public static class Builder {
        ...
        private ColorStateList getActionTextColor(Style style) {
            switch (style) {
                case ALERT:
                    return mContext.getResources().getColorStateList(RUtils.getColor(mContext, "sb_button_text_color_red"));
                case INFO:
                    return mContext.getResources().getColorStateList(RUtils.getColor(mContext, "sb_button_text_color_yellow"));
                case CONFIRM:
                    return mContext.getResources().getColorStateList(RUtils.getColor(mContext, "sb_button_text_color_green"));
                case DEFAULT:
                    return mContext.getResources().getColorStateList(RUtils.getColor(mContext, "sb_default_button_text_color"));
                default:
                    return mContext.getResources().getColorStateList(RUtils.getColor(mContext, "sb_default_button_text_color"));
            }
        }
