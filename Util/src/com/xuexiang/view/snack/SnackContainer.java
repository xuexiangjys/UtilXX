...
class SnackContainer extends FrameLayout {
    ...
    SnackContainer(ViewGroup container) {
        ...
        setId(RUtils.getId(getContext(), "snackContainer"));
        init();
    }
    ...
    private static class SnackHolder {
        ...
        private SnackHolder(Snack snack, View snackView, OnVisibilityChangeListener listener) {
            ...
            button = (TextView) snackView.findViewById(RUtils.getId(snackView.getContext(), "snackButton"));
            messageView = (TextView) snackView.findViewById(RUtils.getId(snackView.getContext(), "snackMessage"));
