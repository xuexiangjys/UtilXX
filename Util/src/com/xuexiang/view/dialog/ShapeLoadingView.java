...
public class ShapeLoadingView extends View {
    ...
    private void init() {
        mPaint = new Paint();
        mPaint.setColor(getResources().getColor(RUtils.getColor(getContext(), "triangle")));
        mPaint.setAntiAlias(true);
        mPaint.setStyle(Paint.Style.FILL_AND_STROKE);
        setBackgroundColor(getResources().getColor(RUtils.getColor(getContext(), "view_bg")));
    }
        ...
        switch (mShape) {
            ...
            case SHAPE_CIRCLE:
                ...
                if (mIsLoading) {
                    ...
                    mPaint.setColor(getResources().getColor(RUtils.getColor(getContext(), "circle")));
                    Path path = new Path();
            ...
            case SHAPE_RECT:
                ...
                if (mIsLoading) {
                    ...
                    mPaint.setColor(getResources().getColor(RUtils.getColor(getContext(), "rect")));
