...
package com.xuexiang.view.dialog.datepicker;
...
public class DoubleDatePickerDialog extends AlertDialog implements OnClickListener, OnDateChangedListener {
	...
	public DoubleDatePickerDialog(Context context, int theme, OnDateSetListener callBack, int year, int monthOfYear,
		...
		View view = inflater.inflate(RUtils.getLayout(themeContext, "dialog_date_picker"), null);
		setView(view);
		mDatePicker_start = (DatePicker) view.findViewById(RUtils.getId(themeContext, "datePickerStart"));
		mDatePicker_end = (DatePicker) view.findViewById(RUtils.getId(themeContext, "datePickerEnd"));
	...
	public void onDateChanged(DatePicker view, int year, int month, int day) {
		if (view.getId() == RUtils.getId(getContext(), "datePickerStart"))
			mDatePicker_start.init(year, month, day, this);
		if (view.getId() == RUtils.getId(getContext(), "datePickerEnd"))
