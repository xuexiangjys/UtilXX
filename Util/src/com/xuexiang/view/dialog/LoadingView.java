...
public class LoadingView extends FrameLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        TypedArray typedArray = context
                .obtainStyledAttributes(attrs, RUtils.getStyleable(context, "LoadingView"));
        mLoadText = typedArray.getString(MResource.getIdByName(context, "styleable", "LoadingView_loadingText"));
        mTextAppearance = typedArray.getResourceId(MResource.getIdByName(context, "styleable", "LoadingView_loadingTextAppearance"), -1);
    ...
    protected void onFinishInflate() {
        ...
        View view = LayoutInflater.from(getContext()).inflate(RUtils.getLayout(getContext(), "load_view"), null);
        ...
        mShapeLoadingView = (ShapeLoadingView) view.findViewById(RUtils.getId(getContext(), "shapeLoadingView"));

        mIndicationIm = (ImageView) view.findViewById(RUtils.getId(getContext(), "indication"));
        mLoadTextView = (TextView) view.findViewById(RUtils.getId(getContext(), "promptTV"));
