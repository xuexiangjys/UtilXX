...
public class CircularProgressView extends View {
    ...
    public CircularProgressView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(
                attrs,
                RUtils.getStyleable(context, "CircularProgressView"),
                defStyleAttr, 0);

        mBorderWidth = a.getDimension(
        		MResource.getIdByName(context, "styleable", "CircularProgressView_borderWidth"),
                getResources().getDimension(RUtils.getDimen(context, "circular_default_border_width")));

        angleAnimatorDuration = a.getInt(
        		MResource.getIdByName(context, "styleable", "CircularProgressView_angleAnimationDurationMillis"),
        ...
        sweepAnimatorDuration = a.getInt(
        		MResource.getIdByName(context, "styleable", "CircularProgressView_sweepAnimationDurationMillis"),
        ...
        minSweepAngle = a.getInt(
        		MResource.getIdByName(context, "styleable", "CircularProgressView_minSweepAngle"),
