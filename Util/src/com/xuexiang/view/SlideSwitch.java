...
public class SlideSwitch extends View {
	...
	public SlideSwitch(Context context, AttributeSet attrs, int defStyleAttr) {
		...
		TypedArray a = context.obtainStyledAttributes(attrs,
				MResource.getIdsByName(context, "styleable", "slideswitch"));
		color_theme = a.getColor(MResource.getIdByName(context, "styleable", "slideswitch_themeColor"),
				COLOR_THEME);
		isOpen = a.getBoolean(MResource.getIdByName(context, "styleable", "slideswitch_isOpen"), false);
		shape = a.getInt(MResource.getIdByName(context, "styleable", "slideswitch_shape"), SHAPE_RECT);
		a.recycle();
	}
