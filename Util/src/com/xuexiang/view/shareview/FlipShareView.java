package com.xuexiang.view.shareview;
...
public class FlipShareView extends View {
    ...
    //shareItem lists
    private List<ShareItem> mItemList = new ArrayList<ShareItem>();
    private List<RectF> mItemRectList = new ArrayList<RectF>();

    private int mAnimType = TYPE_VERTICLE;
    private final List<AnimatorSet> mTotalAnimList = new ArrayList<AnimatorSet>();
    ...
    public void startAnim() {
        ...
        for (int i = 0; i < mItemList.size(); i++) {
            final Collection<Animator> animList = new ArrayList<Animator>();
    ...
    public static class Builder {
        ...
        private View mParentView;
        private List<ShareItem> mShareItemList = new ArrayList<ShareItem>();
