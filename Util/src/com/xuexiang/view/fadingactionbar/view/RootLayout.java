package com.xuexiang.view.fadingactionbar.view;
...
public class RootLayout extends FrameLayout {
    ...
    protected void onLayout (boolean changed, int left, int top, int right, int bottom) {
        ...
        if (mHeaderContainer == null)
            mHeaderContainer = findViewById(RUtils.getId(getContext(), "fab__header_container"));
        if (mListViewBackground == null)
            mListViewBackground = findViewById(RUtils.getId(getContext(), "fab__listview_background"));
