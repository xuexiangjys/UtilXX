 ...
 */
package com.xuexiang.view.fadingactionbar;
...
import com.xuexiang.view.fadingactionbar.view.ObservableScrollView;
import com.xuexiang.view.fadingactionbar.view.ObservableWebViewWithHeader;
import com.xuexiang.view.fadingactionbar.view.OnScrollChangedCallback;
...
public abstract class FadingActionBarHelperBase {
    ...
    private View createWebView() {
        ViewGroup webViewContainer = (ViewGroup) mInflater.inflate(RUtils.getLayout(mContentView.getContext(), "fab__webview_container"), null);
        ...
        mHeaderContainer = (FrameLayout) webViewContainer.findViewById(RUtils.getId(mContentView.getContext(), "fab__header_container"));
    ...
    private View createScrollView() {
        ViewGroup scrollViewContainer = (ViewGroup) mInflater.inflate(RUtils.getLayout(mContentView.getContext(), "fab__scrollview_container"), null);

        ObservableScrollView scrollView = (ObservableScrollView) scrollViewContainer.findViewById(RUtils.getId(mContentView.getContext(), "fab__scroll_view"));
        scrollView.setOnScrollChangedCallback(mOnScrollChangedListener);

        ViewGroup contentContainer = (ViewGroup) scrollViewContainer.findViewById(RUtils.getId(mContentView.getContext(), "fab__container"));
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(
        		LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT);
        mContentView.setLayoutParams(layoutParams);
        contentContainer.addView(mContentView);
        mHeaderContainer = (FrameLayout) scrollViewContainer.findViewById(RUtils.getId(mContentView.getContext(), "fab__header_container"));
        initializeGradient(mHeaderContainer);
        mHeaderContainer.addView(mHeaderView, 0);
        mMarginView = (FrameLayout) contentContainer.findViewById(RUtils.getId(mContentView.getContext(), "fab__content_top_margin"));
    ...
    private View createListView(ListView listView) {
        ViewGroup contentContainer = (ViewGroup) mInflater.inflate(RUtils.getLayout(mContentView.getContext(), "fab__listview_container"), null);
        contentContainer.addView(mContentView);

        mHeaderContainer = (FrameLayout) contentContainer.findViewById(RUtils.getId(mContentView.getContext(), "fab__header_container"));
        initializeGradient(mHeaderContainer);
        mHeaderContainer.addView(mHeaderView, 0);
        ...
        mListViewBackgroundView = contentContainer.findViewById(RUtils.getId(mContentView.getContext(), "fab__listview_background"));
    ...
    private void initializeGradient(ViewGroup headerContainer) {
        View gradientView = headerContainer.findViewById(RUtils.getId(headerContainer.getContext(), "fab__gradient"));
        int gradient = RUtils.getDrawable(headerContainer.getContext(), "fab__gradient");
        if (mLightActionBar) {
            gradient = RUtils.getDrawable(headerContainer.getContext(), "fab__gradient_light");
        }
