package com.xuexiang.view.stepsview;
...
public class StepsView extends LinearLayout implements StepsViewIndicator.OnDrawListener {
    ...
    private void init() {
        View rootView = LayoutInflater.from(getContext()).inflate(RUtils.getLayout(getContext(), "widget_steps_view"), this);
        mStepsViewIndicator = (StepsViewIndicator) rootView.findViewById(RUtils.getId(getContext(), "steps_indicator_view"));
        mStepsViewIndicator.setDrawListener(this);
        mLabelsLayout = (FrameLayout) rootView.findViewById(RUtils.getId(getContext(), "labels_container"));
    }
