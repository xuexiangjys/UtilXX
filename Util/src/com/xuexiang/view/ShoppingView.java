...
public class ShoppingView extends View {
    ...
    private void init(AttributeSet attrs) {
        ...
        TypedArray typeArray = getContext().obtainStyledAttributes(attrs,
        		RUtils.getStyleable(getContext(), "ShoppingView"));
        mDuration = typeArray.getInt(MResource.getIdByName(getContext(), "styleable", "ShoppingView_sv_duration"), DEFAULT_DURATION);
        mShoppingText = TextUtils.isEmpty(typeArray.getString(MResource.getIdByName(getContext(), "styleable", "ShoppingView_sv_text"))) ? DEFAULT_SHOPPING_TEXT : typeArray.getString(MResource.getIdByName(getContext(), "styleable", "ShoppingView_sv_text"));
        //展示文案大小
        int textSize = (int) typeArray.getDimension(MResource.getIdByName(getContext(), "styleable", "ShoppingView_sv_text_size"), sp2px(16));
        //背景色
        int bgColor = typeArray.getColor(MResource.getIdByName(getContext(), "styleable", "ShoppingView_sv_bg_color"), Color.parseColor("#688fdb"));
        typeArray.recycle();
    ...
    private void startRotateAnim() {
        ...
        Collection<Animator> animatorList = new ArrayList<Animator>();
