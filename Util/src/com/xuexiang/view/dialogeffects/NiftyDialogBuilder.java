...
public class NiftyDialogBuilder extends Dialog implements DialogInterface {
    ...
    private static NiftyDialogBuilder mInstance;

    public NiftyDialogBuilder(Context context) {
        super(context, RUtils.getStyle(context, "dialog_untran"));
        init(context);
...
//                if (mInstance == null || !mContext.equals(context)) {
//                    mInstance = new NiftyDialogBuilder(context, RUtils.getStyle(context, "dialog_untran"));
//                }
//            }
//        }
//        mContext = context;
...
//    }
    ...
    private void init(Context context) {
        ...
        mDialogView = View.inflate(context, RUtils.getLayout(context, "dialog_niftylayout"), null);

        mLinearLayoutView = (LinearLayout) mDialogView.findViewById(RUtils.getId(context, "parentPanel"));
        mRelativeLayoutView = (RelativeLayout) mDialogView.findViewById(RUtils.getId(context, "main"));
        mLinearLayoutTopView = (LinearLayout) mDialogView.findViewById(RUtils.getId(context, "topPanel"));
        mLinearLayoutMsgView = (LinearLayout) mDialogView.findViewById(RUtils.getId(context, "contentPanel"));
        mFrameLayoutCustomView = (FrameLayout) mDialogView.findViewById(RUtils.getId(context, "customPanel"));

        mTitle = (TextView) mDialogView.findViewById(RUtils.getId(context, "alertTitle"));
        mMessage = (TextView) mDialogView.findViewById(RUtils.getId(context, "message"));
        mIcon = (ImageView) mDialogView.findViewById(RUtils.getId(context, "icon"));
        mDivider = mDialogView.findViewById(RUtils.getId(context, "titleDivider"));
        mButton1 = (Button) mDialogView.findViewById(RUtils.getId(context, "button1"));
        mButton2 = (Button) mDialogView.findViewById(RUtils.getId(context, "button2"));
