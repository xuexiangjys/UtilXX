...
public class MultipleStatusView extends RelativeLayout {
    ...
    public MultipleStatusView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        final TypedArray a =
            context.obtainStyledAttributes(attrs, RUtils.getStyleable(context, "MultipleStatusView"), defStyleAttr, 0);

        mEmptyViewResId =
            a.getResourceId(RUtils.getStyleableAttribute(context, "MultipleStatusView_emptyView"), RUtils.getLayout(context, "empty_view"));
        mErrorViewResId =
            a.getResourceId(RUtils.getStyleableAttribute(context, "MultipleStatusView_errorView"), RUtils.getLayout(context, "error_view"));
        mLoadingViewResId =
            a.getResourceId(RUtils.getStyleableAttribute(context, "MultipleStatusView_loadingView"), RUtils.getLayout(context, "loading_view"));
        mNoNetworkViewResId = a.getResourceId(RUtils.getStyleableAttribute(context, "MultipleStatusView_noNetworkView"),
            RUtils.getLayout(context, "no_network_view"));
        mContentViewResId = a.getResourceId(RUtils.getStyleableAttribute(context, "MultipleStatusView_contentView"),
            NULL_RESOURCE_ID);
        a.recycle();
    }
    ...
    public final void showEmpty() {
        ...
        if(null == mEmptyView){
            ...
            mEmptyRetryView = mEmptyView.findViewById(RUtils.getId(getContext(), "empty_retry_view"));
    ...
    public final void showError() {
        ...
        if(null == mErrorView){
            ...
            mErrorRetryView = mErrorView.findViewById(RUtils.getId(getContext(), "error_retry_view"));
    ...
    public final void showNoNetwork() {
        ...
        if(null == mNoNetworkView){
            ...
            mNoNetworkRetryView = mNoNetworkView.findViewById(RUtils.getId(getContext(), "no_network_retry_view"));
    ...
    public final void showContent() {
        ...
        if(null == mContentView){
            if(mContentViewResId != NULL_RESOURCE_ID){
                ...
                mContentView = findViewById(RUtils.getId(getContext(), "content_view"));
            }
        }
        showViewByStatus(mViewStatus);
    }
