...
public class UserGuideView extends View {
    ...
    public UserGuideView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if(attrs!=null){
            TypedArray array =  context.obtainStyledAttributes(attrs, RUtils.getStyleable(context, "UserGuideView"));
            highLightStyle = array.getInt(RUtils.getStyleableAttribute(context, "UserGuideView_HighlightViewStyle"), VIEWSTYLE_RECT);
            maskblurstyle = array.getInt(RUtils.getStyleableAttribute(context, "UserGuideView_MaskBlurStyle"), MASKBLURSTYLE_SOLID);
            BitmapDrawable drawable = (BitmapDrawable) array.getDrawable(RUtils.getStyleableAttribute(context, "UserGuideView_tipView"));
            maskColor = array.getColor(RUtils.getStyleableAttribute(context, "UserGuideView_maskColor"), maskColor);
            if(drawable!=null){
    ...
    private void cal(Context context) {
        ...
        statusBarHeight = MeasureUtil.getStatusBarHeight();
...
//        setLayerType(LAYER_TYPE_SOFTWARE,null);
        ...
        jtDownRight = ResourceUtils.getImageFromAssets(context, "jt_down_right.png");
        jtDownLeft = ResourceUtils.getImageFromAssets(context, "jt_down_left.png");
        jtUpLeft = ResourceUtils.getImageFromAssets(context, "jt_up_left.png");
        jtUpRight = ResourceUtils.getImageFromAssets(context, "jt_up_right.png");
    }
