package com.xuexiang.view.morphingbutton;
...
public class MorphingButton extends Button {
    ...
    private void initView() {
        ...
        int cornerRadius = (int) resources.getDimension(RUtils.getDimen(getContext(), "mb_corner_radius_2"));
        int blue = resources.getColor(RUtils.getColor(getContext(), "mb_blue"));
        int blueDark = resources.getColor(RUtils.getColor(getContext(), "mb_blue_dark"));
