package com.xuexiang.view.morphingbutton.impl;
...
import com.xuexiang.view.morphingbutton.MorphingAnimation;
...
public class IndeterminateProgressButton extends MorphingButton {
    ...
    private void init(Context context) {
        ...
        mColor1 = res.getColor(RUtils.getColor(context, "mb_gray"));
        mColor2 = res.getColor(RUtils.getColor(context, "mb_blue"));
        mColor3 = res.getColor(RUtils.getColor(context, "mb_gray"));
        mColor4 = res.getColor(RUtils.getColor(context, "mb_blue"));
