...
public class MyImageLoader {
    ...
    private void init(Context context){
        DisplayImageOptions options = new DisplayImageOptions.Builder()
                .showImageOnLoading(RUtils.getDrawable(context, "default_load"))
                .showImageForEmptyUri(RUtils.getDrawable(context, "default_load"))
                .showImageOnFail(RUtils.getDrawable(context, "default_load"))
                .cacheInMemory(true)
                .cacheOnDisk(true)
