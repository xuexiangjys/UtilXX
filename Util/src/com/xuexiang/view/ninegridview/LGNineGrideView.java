package com.xuexiang.view.ninegridview;
...
public class LGNineGrideView extends ViewGroup {
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, RUtils.getStyleable(context, "LGNineGrideView"));
        space = (int) typedArray.getDimension(RUtils.getStyleableAttribute(context, "LGNineGrideView_space"), defaultSpace);
        singleImageHeightRatio = typedArray.getFloat(RUtils.getStyleableAttribute(context, "LGNineGrideView_singleImageRatio"),1);
        singleImageMode = typedArray.getInteger(RUtils.getStyleableAttribute(context, "LGNineGrideView_singleImageRatioMode"), SINGLE_IMAGE_MODE_SPECIFIED_RATIO);
        widthRatioToParent = typedArray.getFloat(RUtils.getStyleableAttribute(context, "LGNineGrideView_singleImageWidthRatioToParent"), DEFAULTWIDTHRELATIVETOPARENT);
        typedArray.recycle();
    }
