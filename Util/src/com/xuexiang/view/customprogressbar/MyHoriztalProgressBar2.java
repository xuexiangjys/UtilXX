...
public class MyHoriztalProgressBar2 extends ProgressBar {
    ...
    public MyHoriztalProgressBar2(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray ta = getContext().obtainStyledAttributes(attrs, RUtils.getStyleable(context, "MyHoriztalProgressBar2"));
        mProgressbarHeight = (int) ta.getDimension(MResource.getIdByName(context, "styleable", "MyHoriztalProgressBar2_progressbar_height"), mProgressbarHeight);
        mReachColor = ta.getColor(MResource.getIdByName(context, "styleable", "MyHoriztalProgressBar2_reach_color"), mReachColor);
        mUnReachColor = ta.getColor(MResource.getIdByName(context, "styleable", "MyHoriztalProgressBar2_unreach_color"), mUnReachColor);
        mProgressbarRadius = (int) ta.getDimension(MResource.getIdByName(context, "styleable", "MyHoriztalProgressBar2_radius"), mProgressbarRadius);
        mPaint = new Paint();
    ...
    private Bitmap getBackGround() {
        ...
        //Âº?§¥ÁöÑÂçäÂú?        canvas.drawArc(mRectf, 90, 180, false, paint);
        //Áõ¥Á∫ø
        canvas.drawLine(mProgressbarRadius, 0, mRealWidth - mProgressbarRadius, 0, paint);
        //ÁªìÂ∞æÁöÑÂçäÂú?        canvas.translate(mRealWidth - mProgressbarHeight, 0);
