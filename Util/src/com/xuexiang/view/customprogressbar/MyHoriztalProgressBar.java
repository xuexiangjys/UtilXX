...
public class MyHoriztalProgressBar extends ProgressBar {
    ...
    public MyHoriztalProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray ta = getContext().obtainStyledAttributes(attrs, RUtils.getStyleable(context, "MyHoriztalProgressBar"));
        mReachColor = ta.getColor(MResource.getIdByName(context, "styleable", "MyHoriztalProgressBar_progressbar_reach_color"), mReachColor);
        mUnReachColor = ta.getColor(MResource.getIdByName(context, "styleable", "MyHoriztalProgressBar_progressbar_unreach_color"), mUnReachColor);
        mReachHeight = (int) ta.getDimension(MResource.getIdByName(context, "styleable", "MyHoriztalProgressBar_progressbar_reach_height"), mReachHeight);
        mUnReachHeight = (int) ta.getDimension(MResource.getIdByName(context, "styleable", "MyHoriztalProgressBar_progressbar_unreach_height"), mUnReachHeight);
        mTextColor = ta.getColor(MResource.getIdByName(context, "styleable", "MyHoriztalProgressBar_progressbar_text_color"), mTextColor);
        mTextSize = (int) ta.getDimension(MResource.getIdByName(context, "styleable", "MyHoriztalProgressBar_progressbar_text_size"), mTextSize);
        mTextOffset = (int) ta.getDimension(MResource.getIdByName(context, "styleable", "MyHoriztalProgressBar_progressbar_text_offset"), mTextOffset);
        ta.recycle();
