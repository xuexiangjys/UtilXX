...
public class SatelliteAnimationCreator {
    ...
    public static Animation createItemInAnimation(Context context, int index, long expandDuration, int x, int y){        
        ...
        rotate.setInterpolator(context, RUtils.getAnim(context, "sat_item_in_rotate_interpolator"));
        ...
        translate.setInterpolator(context, RUtils.getAnim(context, "sat_item_anticipate_interpolator"));
    ...
    public static Animation createItemOutAnimation(Context context, int index, long expandDuration, int x, int y){
        ...
        translate.setInterpolator(context, RUtils.getAnim(context, "sat_item_overshoot_interpolator"));
        
        RotateAnimation rotate = new RotateAnimation(0f, 360f, 
                Animation.RELATIVE_TO_SELF, 0.5f,
                Animation.RELATIVE_TO_SELF, 0.5f);
        
        rotate.setInterpolator(context, RUtils.getAnim(context, "sat_item_out_rotate_interpolator"));
    ...
    public static Animation createMainButtonAnimation(Context context){
    	return AnimationUtils.loadAnimation(context, RUtils.getAnim(context, "sat_main_rotate_left"));
    }
    
    public static Animation createMainButtonInverseAnimation(Context context){
    	return AnimationUtils.loadAnimation(context, RUtils.getAnim(context, "sat_main_rotate_right"));
    }
    
    public static Animation createItemClickAnimation(Context context){
    	return AnimationUtils.loadAnimation(context, RUtils.getAnim(context, "sat_item_anim_click"));
    }
