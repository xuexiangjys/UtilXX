...
public class ThumbUpView extends View {
    ...
    public void setSearchView(View searchView) {
        this.mThumbUpView = new WeakReference<View>(searchView);
    }
    ...
    private void init(AttributeSet attrs) {
        TypedArray typedArray = getContext().obtainStyledAttributes(attrs, RUtils.getStyleable(getContext(), "ThumbUpView"));
        if (typedArray != null) {
            edgeColor = typedArray.getColor(MResource.getIdByName(getContext(), "styleable", "ThumbUpView_edgeColor"), edgeColor);
            fillColor = typedArray.getColor(MResource.getIdByName(getContext(), "styleable", "ThumbUpView_fillColor"), fillColor);
            cracksColor = typedArray.getColor(MResource.getIdByName(getContext(), "styleable", "ThumbUpView_cracksColor"), cracksColor);
            int type = typedArray.getInteger(MResource.getIdByName(getContext(), "styleable", "ThumbUpView_unlikeType"), 0);
