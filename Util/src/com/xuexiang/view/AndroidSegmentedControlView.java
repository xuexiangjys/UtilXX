...
public class AndroidSegmentedControlView extends RadioGroup {
    ...
    public AndroidSegmentedControlView(Context context, AttributeSet attrs) throws Exception {
        ...
        TypedArray attributes = context.getTheme().obtainStyledAttributes(
                attrs,
                MResource.getIdsByName(context, "styleable", "MultipleSelectionButton"),
                0, 0);

        try {

            selectedColor = attributes.getColor(MResource.getIdByName(context, "styleable", "MultipleSelectionButton_ascv_selectedColor"), selectedColor);
            selectedTextColor = attributes.getColor(MResource.getIdByName(context, "styleable", "MultipleSelectionButton_ascv_selectedTextColor"), selectedTextColor);
            unselectedColor = attributes.getColor(MResource.getIdByName(context, "styleable", "MultipleSelectionButton_ascv_unselectedColor"), unselectedColor);
            unselectedTextColor = attributes.getColor(MResource.getIdByName(context, "styleable", "MultipleSelectionButton_ascv_unselectedTextColor"), selectedColor);
            ...
            defaultSelection = attributes.getInt(MResource.getIdByName(context, "styleable", "MultipleSelectionButton_ascv_defaultSelection"), defaultSelection);
            equalWidth = attributes.getBoolean(MResource.getIdByName(context, "styleable", "MultipleSelectionButton_ascv_equalWidth"), equalWidth);
            stretch = attributes.getBoolean(MResource.getIdByName(context, "styleable", "MultipleSelectionButton_ascv_stretch"), stretch);
            identifier = attributes.getString(MResource.getIdByName(context, "styleable", "MultipleSelectionButton_ascv_identifier"));

            CharSequence[] itemArray = attributes.getTextArray(MResource.getIdByName(context, "styleable", "MultipleSelectionButton_ascv_items"));
            CharSequence[] valueArray = attributes.getTextArray(MResource.getIdByName(context, "styleable", "MultipleSelectionButton_ascv_values"));
    ...
    private void update() {
        ...
        while (itemIterator.hasNext()) {
            ...
            if (i == 0) {
                //Left
                GradientDrawable leftUnselected = (GradientDrawable) mCtx.getResources().getDrawable(RUtils.getDrawable(mCtx, "left_option")).mutate();
                leftUnselected.setStroke(twoDP, selectedColor);

                leftUnselected.setColor(unselectedColor);
                GradientDrawable leftSelected = (GradientDrawable) mCtx.getResources().getDrawable(RUtils.getDrawable(mCtx, "left_option_selected")).mutate();
                ...
                //Right
                GradientDrawable rightUnselected = (GradientDrawable) mCtx.getResources().getDrawable(RUtils.getDrawable(mCtx, "right_option")).mutate();
                rightUnselected.setStroke(twoDP, selectedColor);

                rightUnselected.setColor(unselectedColor);
                GradientDrawable rightSelected = (GradientDrawable) mCtx.getResources().getDrawable(RUtils.getDrawable(mCtx, "right_option_selected")).mutate();
                ...
                //Middle
                GradientDrawable middleUnselected = (GradientDrawable) mCtx.getResources().getDrawable(RUtils.getDrawable(mCtx, "middle_option")).mutate();
                middleUnselected.setStroke(twoDP, selectedColor);
                middleUnselected.setDither(true);
                middleUnselected.setColor(unselectedColor);
                GradientDrawable middleSelected = (GradientDrawable) mCtx.getResources().getDrawable(RUtils.getDrawable(mCtx, "middle_option_selected")).mutate();
    ...
    private OnCheckedChangeListener selectionChangedlistener = new OnCheckedChangeListener() {
        ...
        public void onCheckedChanged(RadioGroup group, int checkedId) {
            if (mListener != null) {   	
            	...
            	String value =  itemMap.get(identifier);
