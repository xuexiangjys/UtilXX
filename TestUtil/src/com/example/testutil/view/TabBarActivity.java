...
/**  
 * 创建时间：2016-6-14 下午6:43:09  
 * 项目名称：UtilTest  
 * @author xuexiang
 * 文件名称：TabBarActivity.java  
 **/
public class TabBarActivity extends BaseActivity {
	...
	private void initTabBarAnimView() {
		...
		tabBarAnimView.bindBtnsForPage(0, R.drawable.nearby_icon,
				R.drawable.search_icon, R.drawable.chats_icon);
		tabBarAnimView.bindBtnsForPage(1, R.drawable.profile_icon,
				R.drawable.edit_icon, 0);
		tabBarAnimView.bindBtnsForPage(2, R.drawable.chats_icon,
				R.drawable.search_icon, 0);
		tabBarAnimView.bindBtnsForPage(3, R.drawable.settings_icon, 0,
