...
import com.xuexiang.view.materialdesign.widget.Dialog;
import com.xuexiang.view.materialdesign.widget.SnackBar;
...
//		SHOW SNACKBAR 
		mButtonFlat = (ButtonFlat) findViewById(R.id.buttonSnackBar);
				...
				new SnackBar(WidgetActivity.this,
						...
						"yes", new OnClickListener() {
							...
							public void onClick(View v) {
								mButtonFlat.setBackgroundColor(Colors.RED);
							}
						}).show();
			}
		});
