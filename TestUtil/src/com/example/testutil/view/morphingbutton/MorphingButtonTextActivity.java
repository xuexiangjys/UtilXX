...
public class MorphingButtonTextActivity extends BaseActivity {

    private int mMorphCounter1 = 1;
    private int mMorphCounter2 = 1;

    public static void startThisActivity(@NonNull Context context) {
        context.startActivity(new Intent(context, MorphingButtonTextActivity.class));
    }
    ...
    private void morphToSuccess(final MorphingButton btnMorph) {
        MorphingButton.Params circle = MorphingButton.Params.create()
                ...
                .width((int) dimen(R.dimen.mb_width_120))
                .height((int) dimen(R.dimen.mb_height_56))
