...
import com.xuexiang.view.niftynotification.Effects;
import com.xuexiang.view.niftynotification.NiftyNotificationView;

public class NiftyNotificationActivity extends Activity {
	private Effects effect;

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_niftynotification);
	}
