...
public class FloatingActionMenuFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.floatingactionmenu_fragment, container, false);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        programFab1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                programFab1.setLabelColors(getActivity().getResources().getColor(R.color.grey),
                		getActivity().getResources().getColor(R.color.light_grey),
                		getActivity().getResources().getColor(R.color.white_transparent));
                programFab1.setLabelTextColor(getActivity().getResources().getColor(R.color.black));
            }
        });
