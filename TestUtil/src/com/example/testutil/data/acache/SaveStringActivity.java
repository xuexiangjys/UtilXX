 ...
 * 
 */
public class SaveStringActivity extends BaseHeadActivity {
	...
	protected int getLayoutId() {
		return R.layout.activity_save_string;
	}
	...
	public void save(View v) {
		if (mEt_string_input.getText().toString().trim().length() == 0) {
			Toast.makeText(this, "Cuz u input is a nullcharacter ... So , when u press \"read\" , if do not show any result , plz don't be surprise", Toast.LENGTH_SHORT).show();
		}
