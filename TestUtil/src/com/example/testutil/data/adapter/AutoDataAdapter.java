...
public class AutoDataAdapter extends BaseContentAdapter<Student> {
	...
	public AutoDataAdapter(Context context, List<Student> list, AutoDBService<Student> databaseService) {
		super(context, list);
