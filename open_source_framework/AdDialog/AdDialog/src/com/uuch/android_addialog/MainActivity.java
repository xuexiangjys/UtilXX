...
public class MainActivity extends Activity {
    ...
    private void initData() {
        ...
        adInfo.setActivityImg("http://scimg.jb51.net/allimg/160718/102-160GQ52P4R0.jpg");
//        adInfo.setActivityImg("https://raw.githubusercontent.com/yipianfengye/android-adDialog/master/images/testImage1.png");
        advList.add(adInfo);

        adInfo = new AdInfo();
        adInfo.setActivityImg("http://sc.jb51.net/uploads/allimg/140523/11-140523144459164.jpg");
//        adInfo.setActivityImg("https://raw.githubusercontent.com/yipianfengye/android-adDialog/master/images/testImage2.png");
        advList.add(adInfo);
        
        adInfo = new AdInfo();
        adInfo.setActivityImg("http://img.sccnn.com/bimg/337/24789.jpg");
        advList.add(adInfo);
    }
    ...
    private void initView() {
        ...
        List<DataBean> mList = new ArrayList<DataBean>();
